...
export default function EnrollPageComponent({ query }) {
  ...
  function display_right_hero_sub_container(difficulty, duration, language) {
    ...
    let icons = [
      {
        icon: <GiHummingbird className={styles.icon_size} key={uuidv4()} />,
        text: "Completely Free",
      },
      {
        icon: <BsGlobeAmericas className={styles.icon_size} key={uuidv4()} />,
        text: "Full Online",
      },
      {
        icon: <SiLevelsdotfyi className={styles.icon_size} key={uuidv4()} />,
        text: difficulty,
      },
      {
        icon: <GiDuration className={styles.icon_size} key={uuidv4()} />,
        text: duration,
      },
      {
        icon: (
          <BiMessageRoundedMinus className={styles.icon_size} key={uuidv4()} />
        ),
        text: language,
      },
    ];
