...
export default function EnrollPageComponent({ query }) {
  ...
  function display_right_hero_sub_container(difficulty, duration, language) {
    ...
    let icons = [
      {
        icon: <GiHummingbird size={icon_size} className={styles.icon_size} />,
        text: "Completely Free",
      },
      { icon: <BsGlobeAmericas size={icon_size} />, text: "Full Online" },
      { icon: <SiLevelsdotfyi size={icon_size} />, text: difficulty },
      { icon: <GiDuration size={icon_size} />, text: duration },
      { icon: <BiMessageRoundedMinus size={icon_size} />, text: language },
    ];
