          ...
          <div className={styles.entire_review_container}>
            <section className={styles.left_rating_container}>
              ...
              <div className={styles.my_rating_container}>
                <h3 className={styles.my_rating}>YOUR RATING</h3>
              </div>
              {/*  */}
              <div className={styles.flex}>
                <div className={styles.user_container_flex}>
                  ...
                  <div>
                    {/* my raiting container */}
                    <div className={styles.user_rating_container}>
                      <AiFillStar
                        className={styles.user_container_star_icon}
                      ></AiFillStar>

                      <p className={styles.user_review_rating}>4.0</p>
                    </div>
                  </div>
                </div>
                {/* my review comment */}
                <div className={styles.my_review_container_c2}>
                  <p className={styles.apos}>ˮ</p>
                  <p className={styles.user_comment}>LOVED IT</p>
                  <p className={styles.user_name}>— {user.display_name}</p>
                </div>
              </div>
            </section>
            {/* =========================================================== */}
