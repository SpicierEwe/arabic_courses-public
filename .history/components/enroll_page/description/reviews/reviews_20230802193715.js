            ...
            <section className={styles.left_rating_container}>
              ...
              <div className={styles.my_rating_container}>
                ...
                <p className={styles.my_comment}>
                  skhnkj nbsjkbnd fkjbnskf jbnsjkhdbf jkhsdbf hjdhsbgfiuh dsifh
                  iuehrwf jhdiouhf sjajr fiehjfkhj dfcnh kjdsnf jknsdkfn
                  sdkjhfuiwehriu hsdkjfh jsdjcknsdjkcn klsjndf hjreuit heruihjt
                  iogu
                </p>
              </div>
              {/*  */}
