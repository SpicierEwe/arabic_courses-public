...
export default function ReviewsComponent({ course_id }) {
  ...
  const x = () => {
    ...
    update(child(dbRef, `${course_id}/reviews`), {
        {
            "_id": ObjectId("612f987acb79aeb89a1db1e1"), // Unique identifier for the comment (automatically generated)
            "user_id": ObjectId("61123456abcd1234567890ab"), // Reference to the user who posted the comment
            "post_id": ObjectId("62123456defg1234567890cd"), // Reference to the post the comment belongs to
            "content": "This is a great post!", // The actual content of the comment
            "created_at": ISODate("2023-08-02T12:34:56Z"), // Timestamp when the comment was created
            "updated_at": ISODate("2023-08-02T12:34:56Z") // Timestamp when the comment was last updated
          }
    });
  };
