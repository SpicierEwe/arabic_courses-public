...
export default function ReviewsComponent() {
  ...
  const reviews_list = [
    ...
    },
    {
      ...
      reviewer_rating: 4,
      reviewer_comment:
        "This course willtakee you places lkhjcfvidhsifu hidhfijhnsdfi hndsiufh giudsh iuhdg iuhiue4h iuhnsiudhf iudh iufhiudh fihnidj nfkjn dkjfhniusdhf iuhwiu hewhf ijhkj fjbh isdhfiesdehb f",
      reviewer_image_link: user.photoURL,
    },
    {
      reviewer_name: "John Doe",
            ...
            <section className={styles.left_rating_container}>
              ...
              <div className={styles.my_rating_container}>
                ...
                <p className={styles.my_comment}>
                  LOVED IT ksjbndjkn kjsdhnfkj ndifjbhniuhne ifwhnjc hjwhn dihnw
                  nkdnc jhndiujf hniuwehjn jweiojf njmf{" "}
                </p>
