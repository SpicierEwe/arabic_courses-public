...
export default function NavbarComponent(props) {
  ...
  function closeMobileNav() {
    document.getElementById("overlay_nav").classList.remove("overlay_nav_open");
    document.getElementById("overlay_nav").classList.add("overlay_nav_close");
    document.getElementById("overlay_nav_bg").style.display = "none";
  }

  function openMobileNav() {
    document.getElementById("overlay_nav_bg").style.display = "block";

    document
      .getElementById("overlay_nav")
      .classList.remove("overlay_nav_close");

    document.getElementById("overlay_nav").classList.add("overlay_nav_open");
  }
  return (
    <div>
      {/* desktop navbar */}
