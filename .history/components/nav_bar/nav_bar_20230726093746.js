...
const NavbarComponent = (props) => {
  ...
  useEffect(() => {
    ...
    const vh = (navbarHeight / viewportHeight) * 100;
    ctx.setNavBarHeight((navbarHeight / viewportHeight) * 100);
    console.log(vh);
  });
          ...
          <div className={styles.user_container}>
            ...
            <div>
              <p className={styles.user_name}>
                Hammad Lorem Ipsum is simply dummy text of the printing and
