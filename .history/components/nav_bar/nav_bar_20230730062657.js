...
export default function NavbarComponent(props) {
  ...
  function openMobileNav() {
    document.getElementById("mobile_nav_bar_overlay").classList.add("overlay_nav_open")    document.getElementById("mobile_nav_bar_overlay").classList.add("overlay_nav_open");
  }
  return (
    <div>
      {/* desktop navbar */}
