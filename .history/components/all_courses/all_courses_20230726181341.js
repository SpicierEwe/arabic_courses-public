...
export function AllCoursesDisplayComponent({ cources_info }) {
  return (
    <NavbarComponent>
...
export async function getServerSideProps() {
  console.log(
    " jfklmdlkfnmlkdj lkjmlk fslkj joi jmfosidjfiosjdo ifjsopjkv jmsd dmvlkm slkmv klsmlk sjdfivjmsdij sjmv ksdj kli"
  );
