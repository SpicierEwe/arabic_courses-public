...
function display_stars(rating_number) {
  const icon_size = 17;
  const filled_star = <AiFillStar className={styles.star} size={icon_size} />;
  const half_star = <AiOutlineStar className={styles.star} size={icon_size} />;
  const empty_star = <AiOutlineStar className={styles.star} size={icon_size} />;
