...
if (typeof window === "undefined") {
  // Running on the server, fs-related code will work
  const fs = require("fs");
  // Your code here...
} else {
  // Running on the client, fs-related code will not work
  // Handle it appropriately for the client...
}
...
export async function AllCoursesDisplayComponent() {
