...
function display_stars(rating_number) {
  const filled_star = <AiFillStar className={styles.star} size={17} />;
  const empty_star = <AiOutlineStar className={styles.star} size={17} />;
  const half_star = <AiOutlineStar className={styles.star} size={17} />;
