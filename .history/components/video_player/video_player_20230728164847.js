...
export default function VideoPlayer({ video_url, videoId, courseId }) {
  ...
  useEffect(() => {
    //  this is the event listener for the video player when the video reaches 90% of its duration its considered as completed and the video is saved in the database
