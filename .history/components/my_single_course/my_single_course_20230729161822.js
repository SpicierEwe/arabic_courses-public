...
export default function MySingleCourseDisplayComponent({ course_id }) {
  ...
  function displaySideBarMobile() {
    ...
    if (!isSideBarOpen) {
      ocument.getElementById("side_nav_icon_outside_side_nav_2").style.display =
        "block";
      d;
      document.getElementById("side_nav_icon_outside_side_nav").style.position =
        "absolute";
    } else {
      document.getElementById("side_nav_icon_outside_side_nav").style.position =
        "relative";
    }
    document.getElementById("side_nav_icon_outside_side_nav_2").style.display =
      "none";
  }
        ...
        <div className={styles.alert_bg}>
          ...
          >
            ...
            <section className={styles.main_content_container}>
              ...
              {
                <HiOutlineMenuAlt2
                  id="side_nav_icon_outside_side_nav"
                  size={23}
                  onClick={() => {
              ...
              {
                <HiOutlineMenuAlt2
                  id="side_nav_icon_outside_side_nav_2"
                  // style={{ display: "none" }}
                  size={23}
                  onClick={() => {
                    displaySideBarMobile();
