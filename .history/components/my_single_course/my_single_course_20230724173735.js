...
export default function MySingleCourseDisplayComponent({ course_data }) {
  ...
  function displaySideBarMobile() {
    setIsSideBarOpen(!is_side_bar_open);
    const side_bar = document.getElementById("side_bar");

    side_bar.classList.toggle(styles.side_bar_container_open);
    side_bar.classList.toggle(styles.side_bar_container_close);

    // if (!is_side_bar_open) {
    //   side_bar.classList.add(styles.side_bar_container_open);
    //   side_bar.classList.remove(styles.side_bar_container_close);
    // } else {
    //   side_bar.classList.remove(styles.side_bar_container_open);
    //   side_bar.classList.add(styles.side_bar_container_close);
    // }
  }
  return (
    <div>
