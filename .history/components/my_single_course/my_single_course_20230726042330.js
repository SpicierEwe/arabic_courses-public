          ...
          <div className={styles.alert}>
            <div>
              <p className={styles.alert_text}>
                ...
                trying to open resources then please disable the extensions that
                you have installed in your browser and refresh the page. If you
                are not sure which extension is bloking, Another way to solve
