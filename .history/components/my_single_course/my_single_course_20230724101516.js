                            ...
                            {array.map((item, index) => {
                              ...
                              for (let i = 0; i < item; i++) {
                                ...
                                const dvd_number = (dvd_index + 1)
                                  .toString()
                                  .padStart(2, "0");
                                const alphabet = available_alphabets[index];
                                item_count_array.push({
                                  number: i + 1,
                                  alphabet: available_alphabets[index],
                                  video_url:
                                    book_index == 0
                                      ? `http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book${book_number}Dvd${dvd_number}-/MAV_BK1_DVD01_PARTA1_512kb.mp4`
