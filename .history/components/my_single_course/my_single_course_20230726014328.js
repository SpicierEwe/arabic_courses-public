          ...
          <div className={styles.alert}>
            <div>
              <p className={styles.alert_text}>
                ...
                trying to open notes then please disable the extensions that you
                have installed in your browser and refresh the page. Another way
                to solve this problem is to open the page in incognito mode.
              </p>
            </div>

            <div className={styles.close_icon} onClick={setIsAlertOpen(false)}>
