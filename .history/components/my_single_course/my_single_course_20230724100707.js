                    ...
                    section["dvds"].map((array, index) => {
                      return (
                        <div key={index} className={styles.dvd_container}>
                          {/* dvd Number */}
                          <p className={styles.dvd_name}>DVD {index + 1}</p>
                          <div>
                            {array.map((item, index) => {
                              ...
                              for (let i = 0; i < item; i++) {
                                item_count_array.push({
                                  ...
                                  video_url : http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book1Dvd01-/MAV_BK1_DVD01_PARTA1_512kb.mp4
                                });
                              }
