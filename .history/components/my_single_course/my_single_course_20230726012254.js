    ...
    <div>
      <div className={styles.alert}>
        <p>
          ...
          <span>This page has been blocked by an extension</span>while trying to
          open notes then please disable the extensions that you have installed
          in your browser and refresh the page. Another way to solve this
          problem is to open the page in incognito mode.
        </p>
        <div>
