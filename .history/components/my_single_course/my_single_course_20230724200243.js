...
export default function MySingleCourseDisplayComponent({ course_data }) {
  ...
  // this function is used to display the side bar for mobile devices
    ...
    <div>
      ...
      {!isSideBarOpen && (
        <HiOutlineMenuAlt2
          ...
          className={styles.side_bar_icon_outside_side_bar}
        />
      )}
      <main className={styles.main_container}>
        ...
        <div
          className={` ${styles.side_bar_container} ${
            isSideBarOpen
              ? styles.side_bar_open
              : styles.side_bar_icon_outside_side_bar
          }`}
        >
          {/* section Name / book name*/}

          <div className={styles.side_bar_icon_inside_side_bar}>
