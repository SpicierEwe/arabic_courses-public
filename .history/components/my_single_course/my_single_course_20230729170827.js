...
the main reason to have a place holder is because the side nav becomes absolute in order to be shown the the opened  navbar and to avoid the movement of the ui the place holder is placed 
    */
    if (!isSideBarOpen) {
          ...
          >
            ...
            <section className={styles.main_content_container}>
              ...
              <div className={styles.nav_icon_container}>
                ...
                {/* this is the place holder for the nav icon above so that the ui flow doesnt shift when the above icons goes absolute
              check ==== displaySideBarMobile() function for how its working */}
                {
                  <HiOutlineMenuAlt2
                    id="side_nav_icon_place_holder"
