      ...
      <div className={styles.resource_container}>
        ...
        <div>
          <p className={styles.quick_note}>
            ...
            be used throughtout the course.
            <br></br>
            <br></br>
            Each section will have its own resources if are available / needed
            for that section.
            <br></br>
            <br></br>
            The solutions for the text books are provided in the resources
            section iteself, also the answer keys for the workbooks are also
            provided there. So be sure to check them out.
          </p>
        </div>
      </div>
    </div>
