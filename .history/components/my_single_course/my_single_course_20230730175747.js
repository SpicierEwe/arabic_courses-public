...
export default function MySingleCourseDisplayComponent({ course_id }) {
  ...
  // this useEffect is used to save the most recent selected video as the last watched video in the local storage
  useEffect(() => {
    ...
    if (lastWatchedVideo) {
      ...
      const last_watched_video_id = lastWatchedVideo[0]["video_id"];
  ...
  useEffect(() => {
    const isAlertSavedBool = localStorage.getItem("rosource_display_error_alert");
    ...
    if (Object.keys(course_data).length !== 0) {
      return (
        <div>
          {/* This is the Alert */}
          {/* {isAlertOpen && ( */}
          {(localStorage.getItem("rosource_display_error_alert") == null
            ? true
            : false) && (
              ...
              <div className={styles.alert}>
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    localStorage.setItem("rosource_display_error_alert", false);
                  }}
                >
