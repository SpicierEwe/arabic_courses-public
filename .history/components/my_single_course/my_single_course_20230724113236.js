      ...
      <main className={styles.main_container}>
        ...
        <section className={styles.main_content_container}>
          ...
          {selected_video_data.length != 0 && (
            // <video controls>
            //   <sourc
            //     src={selected_video_data[0]["video_url"]}
            //     type="video/mp4"
            //   />
            // </video>
            <video controls>
              <sourc
                src="http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book1Dvd01-/MAV_BK1_DVD01_PARTA2_512kb.mp4"
                type="video/mp4"
              />
            </video>
          )}
