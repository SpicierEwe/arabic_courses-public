                          ...
                          <div>
                            {array.map((item, video_index) => {
                              ...
                              for (let i = 0; i < item; i++) {
                                ...
                                const video_code = alphabet + video_number;
                                ...
                                video_item_count_array.push({
                                  ...
                                  alphabet: alphabet,
                                  video_id: `book${book_index + 1}dvd${
                                    dvd_index + 1
                                  }video${available_alphabets[video_index]}${
                                    i + 1
                                  }`,
                                  ...
                                  video_url:
                                    book_index === 0
                                      ? `http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book${book_number}Dvd${dvd_number}-/MAV_BK${book_number}_DVD${dvd_number}_PART${video_code}_512kb.mp4`
                                      : `http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book${book_number}Dvd${dvd_number}/MAV_BK${book_number}_DVD${dvd_number}_PART${video_code}_512kb.mp4`,
                                });
                              }
                                              ...
                                              <div
                                                ...
                                                onClick={() => {
                                                  ...
                                                  const dvd_number = (
                                                    ...
                                                    .toString()
                                                    .padStart(2, "0");
                                                  const video_id = `book${book_number}dvd${dvd_number}video${video_code}`;
                                                  // the url is slightly different for bokk1 and book 2 and book 3 when fr=or book 2 and 3 the url is same but different for book 1
                                                  let video_url =
                                                    book_index === 0
                                                      ? `http://www.archive.org/download/ArabicLanguageCourseVideos-Mpeg4-hi-res-Book${book_number}Dvd${dvd_number}-/MAV_BK${book_number}_DVD${dvd_number}_PART${video_code}_512kb.mp4`
